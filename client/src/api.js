...
axiosToken.interceptors.request.use(
  async (config) => {
    ...
    let token;
    if (State.userInfo.user && State.userInfo.user.accessToken)
      token = State.userInfo.user.accessToken;
...
export const getAllBoard = () => axiosToken.get(`${baseURL}/board`);
export const updateBoard = (data) => axiosToken.patch(`${baseURL}/board`, data);
export const deleteBoard = (id) => axiosToken.delete(`${baseURL}/board/${id}`);
...
export const updateTask = (id, data) =>
  axiosToken.patch(`${baseURL}/task/${id}`, data);
export const deleteTask = (id) => axiosToken.delete(`${baseURL}/task/${id}`);

// comment
export const createNewComment = (data) =>
  axiosToken.post(`${baseURL}/comment`, data);
export const getAllComment = () => axiosToken.get(`${baseURL}/comment`) 
export const updateComment = (id, data) =>
  axiosToken.patch(`${baseURL}/comment/${id}`, data);
export const deleteComment = (id) =>
  axiosToken.delete(`${baseURL}/comment/${id}`);
